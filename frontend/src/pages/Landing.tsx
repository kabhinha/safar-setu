...
const Landing = () => {
    ...
    return (
        <div className="h-screen w-full flex flex-col bg-[#0f172a] text-white overflow-hidden font-sans select-none relative">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-400 uppercase tracking-widest">
                                Government of Sikkim • Dept of Tourism
                            </p>
                        </div>
                    </div>
            ...
            <div className="flex-1 flex overflow-hidden p-6 gap-6">
                    ...
                    <div className="bg-[#1e293b] border border-white/5 rounded-2xl p-4 flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-xs font-bold text-white">12°C Mist</p>
                            </div>
                        </div>
                    </div>
                </aside>

                {/* 2) MIDDLE COLUMN: FUNCTIONAL GRID (50%) */}
                <main className="flex-1 grid grid-cols-2 grid-rows-2 gap-4">

                    {/* Tile 1: Discovery */}
                    <button
                        onClick={() => handleTileClick('/discovery')}
                        className="group relative bg-[#1e293b] rounded-2xl p-6 border border-white/5 hover:border-blue-500/50 hover:bg-[#253045] transition-all duration-200 flex flex-col items-center justify-center text-center gap-4 active:scale-[0.98]"
                    >
                    ...
                    <button
                        ...
                        className="group relative bg-[#1e293b] rounded-2xl p-6 border border-white/5 hover:border-orange-500/50 hover:bg-[#253045] transition-all duration-200 flex flex-col items-center justify-center text-center gap-4 active:scale-[0.98]"
                    >
                ...
                {/* 3) RIGHT COLUMN: PROMOTIONAL & ADS (30%) */}
                <aside className="w-[30%] flex flex-col gap-4">

                    {/* Video Widget */}
                    <div className="flex-[2] bg-gradient-to-br from-[#1e293b] to-[#0f172a] rounded-2xl border border-white/10 overflow-hidden flex flex-col group relative">
            ...
            <div className="h-16 bg-[#1e293b] border-t border-white/10 px-6 flex items-center justify-between">
                ...
                <KioskLoginModal
                    ...
                    onLogin={(token, user) => {
                        ...
                        // setKioskUser(user);
                        // Here you would typically set the context or refetch personalized data
                    }}
                />
            ...
            {/* 5) FOOTER (COMPLIANCE) */}
            <footer className="h-8 bg-black flex items-center justify-between px-6 text-[10px] text-gray-500 uppercase tracking-wider">
