...
import { MapPin, Calendar, Settings, LogOut, ShieldCheck } from 'lucide-react';
        ...
        <div className="pb-32 min-h-screen bg-[#0a0a0a]">
            ...
            <div className="p-4 space-y-8">
                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <Button variant="outline" className="h-12 border-red-500/20 text-red-400 hover:bg-red-500/10 hover:border-red-500/40" onClick={logout}>
