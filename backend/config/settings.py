...
INSTALLED_APPS = [
    ...
    'django_filters',
    'django_extensions',
    # 'citus', # Only if scaling needs specific driver, usually standard postgres is fine
...
MIDDLEWARE = [
    ...
    # Custom Middlewares
    'core.middleware.KioskIsolationMiddleware',
    'rbac.middleware.RbacEnforcementMiddleware',
...
DB_NAME = config('DB_NAME', default='projectx')
...
TIME_ZONE = 'Asia/Kolkata' # NE India Context
...
# Feature Flags
RECO_FEATURE_FLAG = config('RECO_FEATURE_FLAG', default=True, cast=bool)
